...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/orekit_jpype-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/orekit_jpype-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add orekit_jpype
# for installing globally
pixi global install orekit_jpype
```
...
It is possible to list all of the versions of `orekit_jpype` available on your platform:
...
```
pixi search orekit_jpype --channel conda-forge
```
